...
class Categories(Resource):
    ...
    def post(self):
        ...
        cur.execute("SELECT * FROM categories WHERE name='{}';".format(json_data['name']))
    ...
    def get(self):
        ...
        """
        store_id = get_store_id(get_jwt_identity())
        cur.execute("SELECT * FROM categories WHERE store_id='{}';".format(store_id))
...
class CategoryDetail(Resource):
    ...
    def put(self,id):
        ...
        if not category or category[1] != store_id:
            ...
            return msg
        name = category[2]
        cur.execute("UPDATE categories SET name='{}' WHERE id ={}".format(name,id))
        conn.commit()
        cur.execute("SELECT * FROM categories WHERE id={};".format(id))
        new_c = cur.fetchone()
        format_new_c ={
