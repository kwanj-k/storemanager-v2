...
from .views.auth import e2 as editpass_route
from .views.auth import d2 as deleteuser_route
...
api.add_namespace(editpass_route, path="/")
api.add_namespace(deleteuser_route, path="/")
...
api.add_namespace(sales_routes, path="/")
